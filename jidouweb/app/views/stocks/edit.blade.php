...
{{ Form::model($stock, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('stocks.update', $stock->id))) }}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      {{ link_to_route('stocks.show', 'Cancel', $stock->id, array('class' => 'btn btn-lg btn-default')) }}
    </div>
</div>
